...
<main>
  ...
  <ul>
    ...
    <li>Compte mise à jour le <abbr
        title="<?= date_format($updatedAt, $simpleDateFormat) ?>"><?= date_format($updatedAt, $dateFormat) ?></abbr>
    </li>
    <li>Compte créer le <abbr
        title="<?= date_format($createdAt, $simpleDateFormat) ?>"><?= date_format($createdAt, $dateFormat) ?></abbr>
    </li>
  </ul>
